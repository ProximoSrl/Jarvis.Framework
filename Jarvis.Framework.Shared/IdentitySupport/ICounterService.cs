...
namespace Jarvis.Framework.Shared.IdentitySupport
{
    public interface ICounterService
    {
        ...
        /// internal counter. It is only used to understand what is the next id that will be generated you
        /// cannot use to reserve an id because it does not update the underling database.
        /// </summary>
        ...
        /// <summary>
        /// Checks if a value has already been generated by the counter service. This method is useful
        /// to determine if an id is valid because it has a value that is lesser or equal than the last generated.
        /// If the value is greater ususally was not correctly reserved by a counter service so it could be not valid.
        /// </summary>
        /// <param name="serie">The serie to check</param>
        /// <param name="value">The value to validate</param>
        /// <param name="cancellationToken"></param>
        /// <returns>True if the value has already been generated (value &lt;= last generated), false otherwise</returns>
        Task<bool> CheckValidityAsync(string serie, long value, CancellationToken cancellationToken = default);
    }
