...
namespace Jarvis.Framework.Tests.EngineTests.AggregateTests
{
        ...
        AggregateRoot<AggregateTestSampleAggregate1State, AggregateTestSampleAggregate1Id>
    {
        ...
        public void AddToEntity(int value, Boolean thenThrowException)
        {
            Touch();
        ...
        {
            if (sample.InternalState.Accumulator > 50)
            {
                return InvariantsCheckResult.Invalid("Accumulator is greater than 50");
            }
            return base.CheckInvariants();
        }
    }
