...
{
    public class ConventionEventRouterEx : IRouteEventsEx
    {
        ...
        private IAggregateEx registered;

        public ConventionEventRouterEx()
            : this(true)
        { }

        public ConventionEventRouterEx(bool throwOnApplyNotFound)
        {
